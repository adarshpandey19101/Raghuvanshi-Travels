    ...
    <div className="fixed bottom-6 right-4 z-50 flex flex-col gap-3 items-end">
      ...
      >
        <AnimatePresence>
          {showLabel && (
            <motion.div
              ...
              exit={{ opacity: 0, x: 20 }}
              className="glass-card px-4 py-2 text-sm font-medium whitespace-nowrap shadow-glass"
              style={{ color: "#0D1B2A" }}
            >
              Chat on WhatsApp
            </motion.div>
        ...
        <a
          ...
          className="whatsapp-pulse w-14 h-14 rounded-full flex items-center justify-center text-white shadow-lg hover:scale-110 transition-transform duration-300"
